                 ...
                 <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/cb1.jpg" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/cb2.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/cb3.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            ...
                            <div class="row">
                                    ...
                                    <div class="single-product-scroll">
                                        <div class="single-product-cover">
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/cb1.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/cb2.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/cb3.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/cb4.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/cb5.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="single-pro-desc single-pro-desc-no-sidebar">
                                    <div class="single-pro-content">
                                        <h5 class="ec-single-title">Cleaning & Bath Product</h5>
                                        ...
                                        <div class="ec-pro-variation">
                                            <div class="ec-pro-variation-inner ec-pro-variation-size">
                                                ...
                                                <div class="ec-pro-variation-content">
                                                    <ul>
                                                        <!-- <li class="active"><span>100ml</span></li>
            ...
            <div class="row margin-minus-b-30">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                    <div class="ec-product-inner">
                            ...
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/cb1.jpg" alt="Product" />
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Cleaning & Bath Product</a></h5>
                                ...
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/cb1.jpg"
                                                data-src-hover="assetsUser/images/product-image/cb1.jpg"
                                ...
                                <div class="ec-pro-size">
                                    ...
                                    <ul class="ec-opt-size">
                                        <li class="active"><a href="#" class="ec-opt-sz"
                                                ...
                                                data-tooltip="Small">300ml</a></li>
                                        <li><a href="#" class="ec-opt-sz" data-old="$27.00"
                                                data-new="$22.00" data-tooltip="Medium">100ml</a></li>
                                        <li><a href="#" class="ec-opt-sz" data-old="$35.00"
                                                data-new="$30.00" data-tooltip="Extra Large">200ml</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/cb2.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/cb2.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/cb2.jpg"
                                                data-src-hover="assetsUser/images/product-image/cb2.jpg"
                                                data-tooltip="Gray"><span
                                ...
                                <div class="ec-pro-size">
                                    ...
                                    <ul class="ec-opt-size">
                                        <li class="active"><a href="#" class="ec-opt-sz"
                                                ...
                                                data-tooltip="Small">100ml</a></li>
                                        <li><a href="#" class="ec-opt-sz" data-old="$15.00"
                                                data-new="$12.00" data-tooltip="Medium">200ml</a></li>
                                        <li><a href="#" class="ec-opt-sz" data-old="$20.00"
                                                data-new="$17.00" data-tooltip="Extra Large">300ml</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/cb3.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/cb3.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/cb3.jpg"
                                                data-src-hover="assetsUser/images/product-image/cb3.jpg"
                                                data-tooltip="Gray"><span
                                ...
                                <div class="ec-pro-size">
                                    ...
                                    <ul class="ec-opt-size">
                                        <li class="active"><a href="#" class="ec-opt-sz"
                                                ...
                                                data-tooltip="Small">500ml</a></li>
                                        <li><a href="#" class="ec-opt-sz" data-old="$50.00"
                                                data-new="$40.00" data-tooltip="Medium">1000ml</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/cb4.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/cb4.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/cb4.jpg"
                                                data-src-hover="assetsUser/images/product-image/cb4.jpg"
                                                data-tooltip="Gray"><span
                            ...
                            <div class="ec-360-panel ec-360-panel-default">
                                ...
                                <div class="ec-360-panel-body">
                                    <div id="circlr" class="ec-circlr">
                                        <img data-src="assetsUser/images/product-360/00.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/01.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/02.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/03.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/04.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/05.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/06.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/07.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/08.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/09.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/10.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/11.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/12.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/13.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/14.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/15.jpg" src="assetsUser/images/product-360/cb1.jpg" alt="product image">
                                        <div id="loader" class="ec-img-loader"></div>
                                    </div>
                                </div>
                                <p class="ec-tool-play">
                                    <a href="#" class="btn btn-default ec-360-btn"
                                        onclick="crl.play(); return false;"><img src="assetsUser/images/icons/play.svg"
                                            class="svg_img pro_svg" alt="play image" /></a>
                                    <a href="#" class="btn btn-default ec-360-btn"
                                        onclick="crl.stop(); return false;"><img src="assetsUser/images/icons/stop.svg"
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/cb1.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/cb2.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/cb3.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/cb4.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/cb5.jpg" alt="">
                                </div>
                            </div>
                                    ...
                                    <div class="ec-pro-variation-inner ec-pro-variation-size ec-pro-size">
                                        ...
                                        <div class="ec-pro-variation-content">
                                            <ul class="ec-opt-size">
                                                <li class="active"><a href="#" class="ec-opt-sz"
                                                        data-tooltip="Small">100ml</a></li>
                                                <li><a href="#" class="ec-opt-sz" data-tooltip="Medium">200ml</a></li>
                                                <li><a href="#" class="ec-opt-sz" data-tooltip="Large">300ml</a></li>
                                                <li><a href="#" class="ec-opt-sz" data-tooltip="Extra Large">400ml</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
