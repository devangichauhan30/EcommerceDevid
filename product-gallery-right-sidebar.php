                 ...
                 <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/ed1.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            <a href="product-left-sidebar.php" class="cart_pro_title">Elecreical DoorBall</a>
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/ed2.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            <a href="product-left-sidebar.php" class="cart_pro_title">Elecreical DoorBall</a>
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/ed3.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            <a href="product-left-sidebar.php" class="cart_pro_title">Elecreical DoorBall</a>
                                    ...
                                    <div class="single-product-scroll">
                                        <div class="row space-6">
                                            <div class="col-md-6 col-sm-6">
                                                <a class="popup-gallery" href="assetsUser/images/product-image/ed1.jpg"
                                                    title="Blue women purse">
                                                    <img class="example-image"
                                                        src="assetsUser/images/product-image/ed1.jpg" alt="portfolio img">
                                                </a>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <a class="popup-gallery" href="assetsUser/images/product-image/ed2.jpg"
                                                    title="Contrast color Purse">
                                                    <img class="example-image"
                                                        src="assetsUser/images/product-image/ed2.jpg" alt="portfolio img">
                                                </a>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <a class="popup-gallery" href="assetsUser/images/product-image/ed3.jpg"
                                                    title="Green Purse">
                                                    <img class="example-image"
                                                        src="assetsUser/images/product-image/ed3.jpg" alt="portfolio img">
                                                </a>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <a class="popup-gallery" href="assetsUser/images/product-image/ed4.jpg"
                                                    title="Wooden color purse">
                                                    <img class="example-image"
                                                        src="assetsUser/images/product-image/ed4.jpg" alt="portfolio img">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="ec-sidebar-slider">
                        ...
                        <div class="ec-sb-pro-sl">
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/ed1.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Electrical Door Ball</a></h5>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/ed4.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Electrical Door Ball</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/ed5.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Electrical Door Ball</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/ed6.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Electrical Door Ball</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/ed7.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Electrical Door Ball</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/ed8.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Electrical Door Ball</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/ed1.jpg" alt="Product" />
                                ...
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/ed1.jpg"
                                                data-src-hover="assetsUser/images/product-image/ed1.jpg"
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/ed2.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/ed2.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/ed2.jpg"
                                                data-src-hover="assetsUser/images/product-image/ed2.jpg"
                                                data-tooltip="Gray"><span
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/ed3.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/ed3.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/ed3.jpg"
                                                data-src-hover="assetsUser/images/product-image/ed3.jpg"
                                                data-tooltip="Gray"><span
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/ed4.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/ed4.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/ed4.jpg"
                                                data-src-hover="assetsUser/images/product-image/ed4.jpg"
                                                data-tooltip="Gray"><span
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/ed4.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/ed4.jpg" alt="">
                                </div>
