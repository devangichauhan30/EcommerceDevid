                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/sf1.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            <a href="product-left-sidebar.php" class="cart_pro_title">Sport & Fitness Product</a>
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/sf2.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            <a href="product-left-sidebar.php" class="cart_pro_title">Sport & Fitness Product</a>
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/sf3.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            <a href="product-left-sidebar.php" class="cart_pro_title">Sport & Fitness Product</a>
                ...
                <div class="ec-shop-rightside col-lg-12 col-md-12">
                    ...
                    <div class="ec-pro-list-top d-flex">
                        <div class="col-md-6 ec-grid-list">
                            <div class="ec-gl-btn">
                                ...
                                <button class="btn btn-grid-50"><img src="assetsUser/images/icons/grid.svg"
                                        class="svg_img gl_svg" alt="grid" /></button>
                                <button class="btn btn-list-50 active"><img src="assetsUser/images/icons/list.svg"
                    ...
                    <div class="shop-pro-content">
                        <div class="shop-pro-inner list-view-50">
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-6 pro-gl-content width-50">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf1.jpg" alt="Product" />
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Fitness Dumball</a></h5>
                                            ...
                                            <div class="ec-pro-list-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dutmmy.</div>
                                            <span class="ec-price">
                                                ...
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf1.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf1.jpg"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf2.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/sf2.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Fitness</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf2.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf2.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf3.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/sf3.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Cricket Haf Kit</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf3.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf3.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf4.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/sf4.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Cricket Kit</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf4.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf4.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf5.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/sf5.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">BaseBall</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf5.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf5.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf6.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/sf6.jpg" alt="Product" />
                                                </a>
                                                <a href="#" class="quickview" data-link-action="quickview"
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Cricket Bat Ball</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf6.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf6.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf7.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/sf7.jpg" alt="Product" />
                                                </a>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Fitness Item</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf7.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf7.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf8.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/sf8.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf8.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf8.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf9.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/sf9.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Sport Item</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf9.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf9.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#e8c2ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf9.jpg"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf10.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/sf10.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">vollyball</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf10.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf10.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#e8c2ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf10.jpg"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf11.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/sf11.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">HeadBall</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf11.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf11.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#01f1f1;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf11.jpg"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/sf12.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/sf12.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Boxing Gloss</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf12.jpg"
                                                                data-src-hover="assetsUser/images/product-image/sf12.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#90cdf7;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/sf12.jpg"
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/sf1.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/sf1.jpg" alt="">
                                </div>
