                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/kd1.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            <a href="product-left-sidebar.php" class="cart_pro_title">Kid's Toys</a>
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/kd2.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            <a href="product-left-sidebar.php" class="cart_pro_title">Kid's Toys</a>
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/kd3.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            <a href="product-left-sidebar.php" class="cart_pro_title">Kid's Toys</a>
                            ...
                            <div class="row"> 
                                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                                    <div class="ec-product-inner">
                                            ...
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/kd1.jpg" alt="Product" />
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Kid's Toys</a></h5>
                                                ...
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/kd1.jpg"
                                                                data-src-hover="assetsUser/images/product-image/kd1.jpg"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/kd2.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/kd2.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/kd2.jpg"
                                                                data-src-hover="assetsUser/images/product-image/kd2.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/kd3.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/kd3.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/kd3.jpg"
                                                                data-src-hover="assetsUser/images/product-image/kd3.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/kd4.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/kd4.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/kd4.jpg"
                                                                data-src-hover="assetsUser/images/product-image/kd4.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/kd5.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/kd5.jpg" alt="Product" />
                                                </a>
                                                <a href="#" class="quickview" data-link-action="quickview"
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/kd5.jpg"
                                                                data-src-hover="assetsUser/images/product-image/kd5.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/kd6.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/kd6.jpg" alt="Product" />
                                                </a>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/kd6.jpg"
                                                                data-src-hover="assetsUser/images/product-image/kd6.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/kd7.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/kd7.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/kd7.jpg"
                                                                data-src-hover="assetsUser/images/product-image/kd7.jpg"
                                                                data-tooltip="Gray"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    <img class="main-image"
                                                        src="assetsUser/images/product-image/kd8.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assetsUser/images/product-image/kd8.jpg" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/kd8.jpg"
                                                                data-src-hover="assetsUser/images/product-image/kd8.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#e8c2ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="assetsUser/images/product-image/kd8.jpg"
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kd1.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kd2.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kd3.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kd4.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kd5.jpg" alt="">
                                </div>
                            </div>
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product-left-sidebar.php">Kid's Toys</a>
                                </h5>
