    ...
    <section class="ec-payment-fail-page section-space-p">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <img src="assetsUser/images/common/payment error.jpg" alt="payment">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/bebytoytedtbear1.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/bebytoytedtbear1.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/jumbocurrybag.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/jumbocurrybag.jpg" alt="">
                                </div>
