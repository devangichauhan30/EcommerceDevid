					...
					<div class="row">
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								<a href="javascript:0" data-bs-toggle="modal" data-bs-target="#modalContact"
									class="view-detail"><i class="mdi mdi-eye-plus-outline"></i>
								</a>
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v1.jpg" class="mr-3 img-fluid" alt="Avatar Image">
						...
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								...
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v2.webp" class="mr-3 img-fluid" alt="Avatar Image">
						...
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								...
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v3.webp" class="mr-3 img-fluid" alt="Avatar Image">
						...
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								...
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v4.webp" class="mr-3 img-fluid" alt="Avatar Image">
						...
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								...
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v5.jpg" class="mr-3 img-fluid" alt="Avatar Image">
						...
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								...
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v6.webp" class="mr-3 img-fluid" alt="Avatar Image">
									<div class="media-body">
						...
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								...
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v7.webp" class="mr-3 img-fluid" alt="Avatar Image">
						...
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								...
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v8.webp" class="mr-3 img-fluid" alt="Avatar Image">
						...
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								...
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v9.webp" class="mr-3 img-fluid" alt="Avatar Image">
						...
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								...
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v10.webp" class="mr-3 img-fluid" alt="Avatar Image">
									<div class="media-body">
						...
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								...
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v11.webp" class="mr-3 img-fluid" alt="Avatar Image">
						...
						<div class="col-lg-6 col-xl-4 mb-24px">
							<div class="ec-user-card card card-default p-4">
								...
								<a href="javascript:0" class="media text-secondary">
									<img src="assets/img/user/v12.webp" class="mr-3 img-fluid" alt="Avatar Image">
											...
											<div class="profile-content-left px-4">
												<div class="text-center widget-profile px-0 border-0">
													<div class="card-img mx-auto rounded-circle">
														<img src="assets/img/user/v1.jpg" alt="user image">
													</div>
