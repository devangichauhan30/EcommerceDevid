						...
						<div class="table-responsive">
							<table class="table mt-3 table-striped table-responsive table-responsive-large inv-tbl"
								...
								<tbody>
									<tr>
										<td>1</td>
										<td><img class="invoice-item-img" src="assets/img/products/Baby Pink shoes.jpg" alt="product-image" /></td>
									...
									<tr>
										<td>2</td>
										<td><img class="invoice-item-img" src="assets/img/products/Full Cap t-Shirt.jpg" alt="product-image"></td>
									...
									<tr>
										<td>3</td>
										<td><img class="invoice-item-img" src="assets/img/products/Full Sleeve T-Shirt.jpg" alt="product-image"></td>
									...
									<tr>
										<td>4</td>
										<td><img class="invoice-item-img" src="assets/img/products/Round Cap with Belt.jpg" alt="product-image"></td>
