                 ...
                 <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/kids1.jpg" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/kids2.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/kids3.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            ...
                            <div class="row">
                                    ...
                                    <div class="single-product-scroll">
                                        ...
                                        <div class="single-product-cover">
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/kids1.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/kids2.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/kids3.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/kids4.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/kids5.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="single-pro-desc single-pro-desc-no-sidebar">
                                    <div class="single-pro-content">
                                        <h5 class="ec-single-title">Kids Furniture Room</h5>
            ...
            <div class="row margin-minus-b-30">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                    <div class="ec-product-inner">
                            ...
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/kids1.jpg" alt="Product" />
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Kids Furniture Room</a></h5>
                                ...
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/kids1.jpg"
                                                data-src-hover="assetsUser/images/product-image/kids1.jpg"
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/kids2.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/kids2.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/kids2.jpg"
                                                data-src-hover="assetsUser/images/product-image/kids2.jpg"
                                                data-tooltip="Gray"><span
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/kids3.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/kids3.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/kids3.jpg"
                                                data-src-hover="assetsUser/images/product-image/kids3.jpg"
                                                data-tooltip="Gray"><span
                                        ...
                                        <li><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/kids3.jpgg"
                                                data-src-hover="assetsUser/images/product-image/kids3.jpg"
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/kids4.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/kids4.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/kids4.jpg"
                                                data-src-hover="assetsUser/images/product-image/kids4.jpg"
                                                data-tooltip="Gray"><span
                            ...
                            <div class="ec-360-panel ec-360-panel-default">
                                ...
                                <div class="ec-360-panel-body">
                                    <div id="circlr" class="ec-circlr">
                                        <img data-src="assetsUser/images/product-360/kids1.jpg" src="assetsUser/images/product-360/kids4.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/kids1.jpg" src="assetsUser/images/product-360/kids4.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/kids1.jpg" src="assetsUser/images/product-360/kids4.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/kids1.jpg" src="assetsUser/images/product-360/kids4.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/kids1.jpg" src="assetsUser/images/product-360/kids4.jpg" alt="product image">
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kids1.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kids2.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kids3.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kids4.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kids5.jpg" alt="">
                                </div>
                            </div>
