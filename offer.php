...
<body>
                                    ...
                                    <ul class="mega-menu d-block">
                                        <li class="d-flex">
                                            <ul class="d-block">
                                                ...
                                                <li><a href="shop-right-sidebar-col-4.php">Women Western</a>
                                                </li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 margin-b-30">
                    <div class="ec-offer-coupon">
                        <div class="ec-cpn-brand">
                            <img class="ec-brand-img" src="assetsUser/images/offer-image/branded Shoes.jpg" alt="" />
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 margin-b-30">
                    <div class="ec-offer-coupon">
                        <div class="ec-cpn-brand">
                            <img class="ec-brand-img" src="assetsUser/images/offer-image/branded chair.jpg" alt="" />
                        </div>
                        <div class="ec-cpn-title">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 m-auto">
                    <div class="ec-offer-coupon">
                        <div class="ec-cpn-brand">
                            <img class="ec-brand-img" src="assetsUser/images/offer-image/branded Hand Bags.jpg" alt="" />
                        </div>
                        <div class="ec-cpn-title">
    ...
    <section class="labels section-space-p">
        <div class="container">
            ...
            <div class="ec-line-offer" style="background-image: url('assetsUser/images/offer-image/furniture.jpg');">
    ...
    <script src="assetsUser/js/plugins/hot-offer.js"></script>
    <!-- Google translate Js -->
