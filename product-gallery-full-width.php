                 ...
                 <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/storege1.jpg" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/storege2.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                src="assetsUser/images/product-image/storege3.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                            ...
                            <div class="row">
                                    ...
                                    <div class="single-product-scroll">
                                        <div class="row space-6">
                                            <div class="col-md-6 col-sm-6">
                                                <a class="popup-gallery" href="assetsUser/images/product-image/storege1.jpg"
                                                    title="Blue women purse">
                                                    <img class="example-image"
                                                        src="assetsUser/images/product-image/storege1.jpg" alt="portfolio img">
                                                </a>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <a class="popup-gallery" href="assetsUser/images/product-image/storege2.jpg"
                                                    title="Contrast color Purse">
                                                    <img class="example-image"
                                                        src="assetsUser/images/product-image/storege2.jpg" alt="portfolio img">
                                                </a>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <a class="popup-gallery" href="assetsUser/images/product-image/storege3.jpg"
                                                    title="Green Purse">
                                                    <img class="example-image"
                                                        src="assetsUser/images/product-image/storege3.jpg" alt="portfolio img">
                                                </a>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <a class="popup-gallery" href="assetsUser/images/product-image/storege4.jpg"
                                                    title="Wooden color purse">
                                                    <img class="example-image"
                                                        src="assetsUser/images/product-image/storege4.jpg" alt="portfolio img">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="single-pro-desc single-pro-desc-no-sidebar">
                                    <div class="single-pro-content">
                                        <h5 class="ec-single-title">Storege Pendrive</h5>
            ...
            <div class="row margin-minus-b-30">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                    <div class="ec-product-inner">
                            ...
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/storege1.jpg" alt="Product" />
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Black Pendrive</a></h5>
                                ...
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/storege1.jpg"
                                                data-src-hover="assetsUser/images/product-image/storege1.jpg"
                                ...
                                <div class="ec-pro-size">
                                    ...
                                    <ul class="ec-opt-size">
                                        <li class="active"><a href="#" class="ec-opt-sz"
                                                ...
                                                data-tooltip="Small">4GB</a></li>
                                        <li><a href="#" class="ec-opt-sz" data-old="$27.00"
                                                data-new="$22.00" data-tooltip="Medium">8GB</a></li>
                                        <li><a href="#" class="ec-opt-sz" data-old="$35.00"
                                                data-new="$30.00" data-tooltip="Extra Large">16GB</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/storege2.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/storege2.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">Blue Pendrive</a></h5>
                            <div class="ec-pro-rating">
                                <i class="ecicon eci-star fill"></i>
                                <i class="ecicon eci-star fill"></i>
                                <i class="ecicon eci-star fill"></i>
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/storege2.jpg"
                                                data-src-hover="assetsUser/images/product-image/storege2.jpg"
                                                data-tooltip="Gray"><span
                                ...
                                <div class="ec-pro-size">
                                    ...
                                    <ul class="ec-opt-size">
                                        ...
                                        <li><a href="#" class="ec-opt-sz" data-old="$15.00"
                                                data-new="$12.00" data-tooltip="Medium">8GB</a></li>
                                        <li><a href="#" class="ec-opt-sz" data-old="$20.00"
                                                data-new="$17.00" data-tooltip="Extra Large">16GB</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/storege3.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/storege3.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">White Pendrive</a></h5>
                            <div class="ec-pro-rating">
                                <i class="ecicon eci-star fill"></i>
                                <i class="ecicon eci-star fill"></i>
                                <i class="ecicon eci-star fill"></i>
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/storege3.jpg"
                                                data-src-hover="assetsUser/images/product-image/storege3.jpg"
                                                data-tooltip="Gray"><span
                                ...
                                <div class="ec-pro-size">
                                    ...
                                    <ul class="ec-opt-size">
                                        <li class="active"><a href="#" class="ec-opt-sz"
                                                ...
                                                data-tooltip="Small">16GB</a></li>
                                        <li><a href="#" class="ec-opt-sz" data-old="$50.00"
                                                data-new="$40.00" data-tooltip="Medium">32GB</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/storege4.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/storege4.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="product-left-sidebar.php">White-blue pendrive</a></h5>
                            <div class="ec-pro-rating">
                                <i class="ecicon eci-star fill"></i>
                                <i class="ecicon eci-star fill"></i>
                                <i class="ecicon eci-star fill"></i>
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/storege4.jpg"
                                                data-src-hover="assetsUser/images/product-image/storege4.jpg"
                                                data-tooltip="Gray"><span
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/storege1.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/storege2.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/storege3.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/storege4.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/storege5.jpg" alt="">
                                </div>
                            </div>
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product-left-sidebar.php">Pendrive Storege</a>
                                </h5>
                                    ...
                                    <div class="ec-pro-variation-inner ec-pro-variation-size ec-pro-size">
                                        ...
                                        <div class="ec-pro-variation-content">
                                            <ul class="ec-opt-size">
                                                ...
                                                <li><a href="#" class="ec-opt-sz" data-tooltip="Medium">4GB</a></li>
                                                <li><a href="#" class="ec-opt-sz" data-tooltip="Large">8Gb</a></li>
                                                <li><a href="#" class="ec-opt-sz" data-tooltip="Extra Large">16GB</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
