						...
						<div class="row mb-m-24px">
								...
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Baby Pink shoes.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>

										<h5 class="card-title text-dark">Brand A</h5>
										<p class="item-count">2535<span> items</span></p>
										<span class="brand-delete mdi mdi-delete-outline"></span>
									</div>
								</div>
							</div>
							<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6">
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Boat Ear buds.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>
							...
							<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6">
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Big Basket Bag.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>
							...
							<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6">
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Big basket Lather Bag.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>
							...
							<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6">
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Baby shoes.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>
							...
							<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6">
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Full Cap t-Shirt.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>
							...
							<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6">
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Full Purse Green.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>
							...
							<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6">
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Full Sleeve Cap T-Shirt.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>
							...
							<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6">
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Full Sleeve T-Shirt.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>
							...
							<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6">
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Digital Watch.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>
							...
							<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6">
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Doctor Kit for Kids.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>
							...
							<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6">
								<div class="card card-default">
									<div class="card-body text-center p-24px">
										<div class="image mb-3">
											<img src="assets/img/brand/Cowboy Hat.jpg" class="img-fluid rounded-circle"
												alt="Avatar Image">
										</div>
								...
								<div class="modal-body p-0" data-simplebar style="height:320px">
									<ul class="list-unstyled border-top mb-0">
										<li>
											<div class="media media-message">
												...
												<div class="media-body d-flex justify-content-between align-items-center">
													<div class="message-contents">
														<h4 class="title">Earth Fashion</h4>
										...
										<li>
											<div class="media media-message ">
												<div class="position-relative mr-3">
													<img class="rounded-circle" src="assets/img/brand/2.jpg"
														alt="Image">
													<span class="status active"></span>
												</div>
												<div
										...
										<li>
											<div class="media media-message">
												<div class="position-relative mr-3">
													<img class="rounded-circle" src="assets/img/brand/3.jpg"
														alt="Image">
													<span class="status away"></span>
												</div>
												<div
										...
										<li>
											<div class="media media-message">
												<div class="position-relative mr-3">
													<img class="rounded-circle" src="assets/img/brand/4.jpg"
														alt="Image">
													<span class="status active"></span>
												</div>
										...
										<li>
											<div class="media media-message">
												<div class="position-relative mr-3">
													<img class="rounded-circle" src="assets/img/brand/5.jpg"
														alt="Image">
													<span class="status away"></span>
												</div>
										...
										<li>
											<div class="media media-message">
												...
												<div
													class="media-body d-flex justify-content-between align-items-center">
													<div class="message-contents">
														<h4 class="title">William Fabric</h4>
														<p class="last-msg">Lorem ipsum dolor sit, amet consectetur
															adipisicing elit. Nam itaque doloremque
															odio,
															eligendi delectus vitae.</p>
										...
										<li>
											<div class="media media-message">
												...
												<div
													class="media-body d-flex justify-content-between align-items-center">
													<div class="message-contents">
														<h4 class="title">Abriel Creation</h4>
														<p class="last-msg">Lorem ipsum dolor sit, amet consectetur
															adipisicing elit. Nam itaque doloremque
															odio,
															eligendi delectus vitae.</p>
										...
										<li>
											<div class="media media-message">
												...
												<div
													class="media-body d-flex justify-content-between align-items-center">
													<div class="message-contents">
														<h4 class="title">Emma Fashion</h4>
														<p class="last-msg">Lorem ipsum dolor sit, amet consectetur
															adipisicing elit. Nam itaque doloremque
															odio,
															eligendi delectus vitae.</p>
										...
										<li>
											<div class="media media-message">
												...
												<div
													class="media-body d-flex justify-content-between align-items-center">
													<div class="message-contents">
														<h4 class="title">Kings Fashion</h4>
														<p class="last-msg">Lorem ipsum dolor sit, amet consectetur
															adipisicing elit. Nam itaque doloremque
															odio,
															eligendi delectus vitae.</p>
