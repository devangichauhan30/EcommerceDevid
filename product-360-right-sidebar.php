...
<body class="product_page">
                                ...
                                <div class="single-pro-img">
                                    <div class="single-product-scroll">
                                        <a class="ec-360-lbl" data-link-action="quickview" title="360 view" data-bs-toggle="modal" data-bs-target="#ec_360_view_modal">
                                            <img src="assetsUser/images/icons/360-degrees.png" alt="view image">
                                        </a>
                                        <div class="single-product-cover">
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/kct1.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/kct2.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/kct3.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/kct4.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assetsUser/images/product-360/kct5.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                        ...
                        <div class="ec-sb-pro-sl">
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/kct1.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">kitchen Tools</a></h5>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/kct2.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">kitchen Tools</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/kct3.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">kitchen Tools</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/kct4.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">kitchen Tools</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/kct5.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">kitchen Tools</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/kct6.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">kitchen Tools</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/kct7.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">kitchen Tools</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div>
                                <div class="ec-sb-pro-sl-item">
                                    <a href="product-left-sidebar.php" class="sidekka_pro_img"><img
                                            src="assetsUser/images/product-image/kct8.jpg" alt="product" /></a>
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href="product-left-sidebar.php">kitchen Tools</a></h5>
                                        <div class="ec-pro-rating">
                                            <i class="ecicon eci-star fill"></i>
                            ...
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/kct1.jpg" alt="Product" />
                                ...
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/kct1.jpg"
                                                data-src-hover="assetsUser/images/product-image/kct1.jpg"
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/kct2.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/kct2.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/kct2.jpg"
                                                data-src-hover="assetsUser/images/product-image/kct2.jpg"
                                                data-tooltip="Gray"><span
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/kct3.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/kct3.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/kct3.jpg"
                                                data-src-hover="assetsUser/images/product-image/kct3.jpg"
                                                data-tooltip="Gray"><span
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.php" class="image">
                                    <img class="main-image"
                                        src="assetsUser/images/product-image/kct4.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="assetsUser/images/product-image/kct4.jpg" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    ...
                                    <ul class="ec-opt-swatch ec-change-img">
                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                data-src="assetsUser/images/product-image/kct4.jpg"
                                                data-src-hover="assetsUser/images/product-image/kct4.jpg"
                                                data-tooltip="Gray"><span
                            ...
                            <div class="ec-360-panel ec-360-panel-default">
                                ...
                                <div class="ec-360-panel-body">
                                    <div id="circlr" class="ec-circlr">
                                        <img data-src="assetsUser/images/product-360/kct1.jpg" src="assetsUser/images/product-360/FancyLadiesSandal.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/kct1.jpg" src="assetsUser/images/product-360/FancyLadiesSandal.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/kct1.jpg" src="assetsUser/images/product-360/FancyLadiesSandal.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/kct1.jpg" src="assetsUser/images/product-360/FancyLadiesSandal.jpg" alt="product image">
                                        <img data-src="assetsUser/images/product-360/kct1.jpg" src="assetsUser/images/product-360/FancyLadiesSandal.jpg" alt="product image">
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kct1.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kct2.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kct3.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kct4.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="assetsUser/images/product-image/kct5.jpg" alt="">
                                </div>
                            </div>
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product-left-sidebar.php">kitchen Tools</a>
                                </h5>
    ...
    <script src="assetsUser/js/plugins/product-360.js"></script>
    <!-- Google translate Js -->
